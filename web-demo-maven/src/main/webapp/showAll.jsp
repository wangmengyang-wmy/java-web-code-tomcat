...
<%@ page import="com.dao.impl.UserDaoImplement" %>
...
<%--        <form action="/web-demo-maven/updateServlet" method="post">--%>
<%--            <tr>--%>
<%--                <td><input type="text" value="${U.name}" name="name" ></td>--%>
<%--                <td><input type="text" value="${U.password}" name="password"></td>--%>
<%--                <td><input type="text" value="${U.id}" name="id" readonly="true"></td>--%>
<%--                <td><a href="/web-demo-maven/deleteServlet?id=${U.id}">删除</a><input type="submit" value="更新"/></td>--%>
<%--            </tr>--%>
<%--        </form>--%>
<%--    </c:forEach>--%>
<%--</table>--%>
